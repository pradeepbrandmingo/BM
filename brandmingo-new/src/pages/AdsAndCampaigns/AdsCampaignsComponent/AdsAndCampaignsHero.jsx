              ...
              <div className="wd-device-wrapper">
                ...
                <div className="wd-laptop">
                  ...
                  <div className="wd-laptop-bar">
                    ...
                    <div className="wd-url-bar">
                      ...
                      <span className="wd-url-text">ads.brandmingo.com</span>
                    </div>
                  </div>
                  ...
                  <div className="wd-laptop-nav">
                    ...
                    <div className="wd-mock-cta-small">Launch Ads →</div>
                  </div>
                  ...
                  <div className="wd-laptop-body">
                    ...
                    <div className="wd-dash-header">
                      <div className="wd-dash-title">
                        Campaign <span>Performance</span>
                      </div>
                ...
                <div className="wd-phone">
                  ...
                  <div className="wd-phone-body">
                    ...
                    <div className="wd-phone-widget-label">Today's Leads</div>
                      ...
                      {[
                        ...
                        <div className="wd-phone-ch-row" key={i}>
                          ...
                          >
                            <i
                              className={ch.icon}
                              style={{ color: ch.color, fontSize: 7 }}
                            />
                          </div>
                          <span className="wd-phone-ch-name">{ch.name}</span>
                          <span className="wd-phone-ch-val">{ch.val}</span>
                        </div>
                      ))}
                    </div>
...
export default AdsAndCampaignsHero;
