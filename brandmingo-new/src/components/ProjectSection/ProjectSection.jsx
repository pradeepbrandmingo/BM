...
// // ── Data — ek jagah se aa raha hai, yahan kuch likhne ki zaroorat nahi ──
...
//                     {/* Double image for CSS hover effect — do not remove */}
...
//                     {/* TODO: replace hardcoded tags with item.tags when ready */}
//                     <ul>
//                       <li>{item.category}</li>
//                     </ul>
//                   </div>
...
//       {/* Popup — renders outside section so z-index always works */}
//       {activeProject && (
